...
public class ServiceUser {
    ...
    public List<User> getALLUser(){
        ...
        for (User u:list){
            Account account = restTemplate.getForObject("http://localhost:8089/api/acc/"+u.getId(),Account.class);
    ...
    public User findById(@PathVariable Integer id){
      ...
      Account account = restTemplate.getForObject("http://localhost:8089/api/acc/"+id,Account.class);
